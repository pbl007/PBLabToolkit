...
path2TifFiles = '/Users/pb/Data/PBLab/Shany/AT/20170201_1p4_R16_Cyc2/tifs/';
...
parfor iTASK = 1 : nTasks
    for iCH = 1 : nChannels
        ...
        tifName = sprintf('%s_%s_%s_Z%04d_R%03d_C%03d_Ch%02d.tif',animalIDStr,cycleNumStr,ribbonIDStr,T.Z(iTASK),T.R(iTASK),T.C(iTASK),iCH);
...
%% save table as well
save(fullfile(path2TifFiles,'layoutTable.mat'),'T')
...
fid = fopen(fullfile(path2TifFiles,'simpleLayout.txt'),'w+');
