...
% Last Modified by GUIDE v2.5 23-Dec-2015 11:00:58
...
%first callect all information to send 
params.SampleDuration = str2double(get(handles.Sample_Duration_Input,'String'));
params.TrainingStages = handles.TrainingStages.SelectedObject.String;


%set experiment character based on user selection of training stage
switch params.TrainingStages
    case 'Discrimination'
        arduionoCommand = 'M' % you must change this!!!
    case 'Water after 1st and auditory cue'
        arduionoCommand = '1'
end
