...
%  which is connected.
USBport = '/dev/tty.usbmodem1411'; %%PB changed
...
% entries:
availableDevices = ls('/dev/tty.usb*'); % OS X
...
fprintf ('\n this chunk has %d elements.',length(newData))
    end
