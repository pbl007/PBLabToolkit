...
prmts.file_parts{1} = '/Users/pb/Data/PBLab/David/WideField_GCamP6/#2_vasc_occ_RH/stim_right_bin.tif';
% prmts.file_parts{2} = '';
...
%stim properties (as set in Master 8)
prmts.stim_delay_msec = 75;
prmts.stim_duration_msec = 75;
prmts.stim_interval_msec = 333;
