...
if options.classify_comp
    ...
    [rval_space,rval_time,ind_space,ind_time] = classify_comp_corr(data,Am,Cm,[bin,ones(d,1)],[fin;double(F_dark)*ones(1,size(fin,2))],options); %pablo cast F_dark to double
