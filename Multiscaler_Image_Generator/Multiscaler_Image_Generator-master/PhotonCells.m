...
function [PhotonCellArray, Num_of_Lines, StartOfFramesChannel, MaxNumOfEventsInLine] = PhotonCells(START_Dataset, STOP1_Dataset, STOP2_Dataset, PMT_Channel_Num)
...
switch PMT_Channel_Num
    case 1
        ...
        if mean_frequency_start < mean_frequency_stop2 
            ...
            [PhotonCellArray, MaxNumOfEventsInLine] = DataList(TotalEvents, Num_of_Lines, STOP1_Dataset, DataStarts);
    ...
    case 2
        ...
        if mean_frequency_start < mean_frequency_stop1
            ...
            [PhotonCellArray, MaxNumOfEventsInLine] = DataList(TotalEvents, Num_of_Lines, STOP2_Dataset, DataStarts);
    ...
    case 6
        ...
        if mean_frequency_stop2 < mean_frequency_stop1
            ...
            [PhotonCellArray, MaxNumOfEventsInLine] = DataList(TotalEvents, Num_of_Lines, START_Dataset, DataStarts);
